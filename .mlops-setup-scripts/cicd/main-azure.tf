resource "databricks_group" "mlops-service-principal-group-staging" {
  display_name = "mlc_mlops_stacks-service-principals"
...
module "azure_create_sp" {
  ...
  service_principal_name       = "mlc_mlops_stacks-cicd"
  project_directory_path       = "/mlc_mlops_stacks"
  azure_tenant_id              = var.azure_tenant_id
  service_principal_group_name = "mlc_mlops_stacks-service-principals"
}
...
provider "databricks" {
  alias = "prod_sp"
  host  = "https://adb-2290777133481849.9.azuredatabricks.net"
